    ...
    {props.data.segments.length > 0 && (
      <div class="table-scroll">
        <table class="responsive-table">
          ...
          <tbody>
            {props.data.segments.map((segment: any) => (
              <tr>
                <td data-label="Name">{segment.join_date}</td>
                <td data-label="Starting Position">
                  [{segment.starting_latitude}, {segment.starting_longitude}]
                </td>
                <td data-label="Finish Position">
                  [{segment.ending_latitude}, {segment.ending_longitude}]
                </td>
              </tr>
            ))}
          </tbody>
